...
<img src="http://blog-1259650185.cosbj.myqcloud.com/img/202202/10/1644472512.png" alt="6" style="zoom:50%;" />
...
<img src="http://blog-1259650185.cosbj.myqcloud.com/img/202202/10/1644472953.png" alt="7" style="zoom:50%;" />
...
<img src="http://blog-1259650185.cosbj.myqcloud.com/img/202202/10/1644473274.png" alt="8" style="zoom: 33%;" />
...
<img src="http://blog-1259650185.cosbj.myqcloud.com/img/202202/10/1644473825.png" alt="9" style="zoom: 50%;" />
...
<img src="http://blog-1259650185.cosbj.myqcloud.com/img/202202/10/1644474672.png" alt="10" style="zoom:50%;" />
...
<img src="http://blog-1259650185.cosbj.myqcloud.com/img/202202/10/1644476039.png" alt="11" style="zoom:50%;" />
...
<img src="http://blog-1259650185.cosbj.myqcloud.com/img/202202/10/1644476116.png" alt="12" style="zoom:50%;" />
...
<img src="http://blog-1259650185.cosbj.myqcloud.com/img/202202/10/1644476905.png" alt="13" style="zoom:67%;" />
...
<img src="http://blog-1259650185.cosbj.myqcloud.com/img/202202/10/1644479077.png" alt="3" style="zoom:50%;" />
...
```java
final RingBuffer<MessageEvent> disruptorMessageBuffer = RingBuffer.createSingleProducer(new MessageFactory(), ringBufferSize, new BlockingWaitStrategy());
```

### 创建相关的业务Handler

在该场景中需要定义两个handler，由于是具体的业务逻辑，这里不做详细介绍，说明如下：

```java
public class SimpleParserStage implements EventHandler<MessageEvent>, LifecycleAware {
    ...
    public SimpleParserStage(LogContext context) {
        decoder = new LogDecoder(LogEvent.UNKONWN_EVENT, LogEvent.ENUM_END_EVENT);
...
```java
SequenceBarrier sequenceBarrier = disruptorMessageBuffer.newBarrier();
```

### 创建事件处理器

<img src="http://blog-1259650185.cosbj.myqcloud.com/img/202202/10/1644479763.png" alt="4" style="zoom: 67%;" />
...
生产者这边主要是将数据写入到RingBuffer中，从而让下游消费。

<img src="http://blog-1259650185.cosbj.myqcloud.com/img/202202/10/1644480078.png" alt="5" style="zoom:50%;" />
...
<img src="http://blog-1259650185.cosbj.myqcloud.com/img/202202/13/1644685550.png" alt="6" style="zoom:75%;" />
...
<img src="http://blog-1259650185.cosbj.myqcloud.com/img/202202/13/1644685605.png" alt="7" style="zoom:75%;" />

## 参考

[高性能队列——Disruptor](https://tech.meituan.com/2016/11/18/disruptor.html)

[《重学Java高并发》Disruptor使用实战](https://mp.weixin.qq.com/s/64RjeEOSvU4MSiiJDW4ykg)
